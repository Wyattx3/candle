...
- Subagent budget is hard-capped: `MAX_SUBAGENT_TOOL_CALLS = 50`, `SUBAGENT_TIMEOUT_MS = 120_000`. The parent's abort signal propagates so user cancellation kills the worker too.
